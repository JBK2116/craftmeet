    ...
    >
        ...
        >
            ...
            <p class="mb-6 text-center text-small text-muted-foreground">
                If <span class="font-medium text-foreground">{email}</span> is associated with an account,
            ...
            <p class="mt-4 text-center text-label text-muted-foreground">
                Didn't receive it? Check your spam folder or
                <button
                    onclick={closeModal}
                    class="font-medium text-foreground underline-offset-2 hover:underline transition-colors"
                >
                    try again
                </button>.
            </p>
